...
## Description
IPL-Results-Prediction is a basic machine learning project that is made using the basics of `pandas`, `numpy`, `seaborn` and different in-built functions and model classes from the `scikit-learn`. It has two individual components: Match Outcome Prediction and Final Score Prediction.
